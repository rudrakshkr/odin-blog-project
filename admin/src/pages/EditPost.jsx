                            ...
                            <section className="flex flex-1 flex-col gap-8">
                                ...
                                <div>
                                    ...
                                    <input 
                                        ...
                                        required
                                    />
                                    <p className="text-sm text-slate-400">Max 60 characters</p>
                                </div>
                                ...
                                <div className="flex flex-col gap-5">
                                    ...
                                    <div className="p-6 border shadow-sm border-slate-200 rounded-lg bg-white">
                                        ...
                                        >
                                            ...
                                            {isSubmitting ? "Saving Changes..." : "Edit Post"}
                                        </button>
                                    </div>
                                    ...
                                    <div className="p-6 border shadow-sm border-slate-200 rounded-lg bg-white">
                                        ...
                                        <div className="flex flex-col mb-1 gap-2">
                                            <label htmlFor="tags">Read Time <span className="text-[13px] text-slate-500">(In Minutes)</span></label>
                                            <input 
                                                type="number"
                                                name="postReadMin" 
                                                id="postReadMin" 
